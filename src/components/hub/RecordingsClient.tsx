      ...
      <div className="bg-white rounded-lg border border-slate-200 px-6 py-10 text-center">
        ...
        {sharepointFolderUrl && (
          <a
            ...
            className="inline-flex items-center gap-1.5 mt-4 text-sm font-medium text-[#0078D4] hover:underline"
          >
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-3 py-2 text-sm border border-slate-200 rounded-lg w-full sm:w-72 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400"
          />
        </div>
        {sharepointFolderUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-sm font-medium text-[#0078D4] hover:underline"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
            </svg>
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((file) => {
            ...
            return (
              ...
              >
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${ICON_COLORS[icon]}`}>
